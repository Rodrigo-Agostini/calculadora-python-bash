Este é um Script em Bash que implementa uma calculadora interativa via terminal. Ele permite realizar operações básicas como adição, subtração, multiplicação e divisão.
